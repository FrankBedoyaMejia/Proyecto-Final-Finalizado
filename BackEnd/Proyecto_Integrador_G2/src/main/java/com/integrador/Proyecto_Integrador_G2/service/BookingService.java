...
public class BookingService {
    ...
    public List<Booking> searchBookingByProduct(Long id){
        LOGGER.info("The product's bookings with ID "+ id +" were searched:");
        return bookingRepository.findByProduct_idLike(id);
    }
